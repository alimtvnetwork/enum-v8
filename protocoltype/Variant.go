...
func (it Variant) IsTcp() bool {
	return it == Tcp
}

func (it Variant) IsTcpOrUdp() bool {
	return it == Tcp || it == Udp
}

func (it Variant) IsUdp() bool {
	return it == Udp
}

func (it Variant) IsIcmp() bool {
	return it == Icmp
}

func (it Variant) IsGrpc() bool {
	return it == Grpc
}

func (it Variant) IsRpc() bool {
	return it == Rpc
}

func (it Variant) IsOAuth() bool {
	return it == OAuth
}

func (it Variant) IsRest() bool {
	return it == Rest
}

func (it Variant) IsHttp() bool {
	return it == Http
}

func (it Variant) IsHttps() bool {
	return it == Https
}

func (it Variant) IsHttpsV3() bool {
	return it == HttpsV3
}

func (it Variant) IsMSMQ() bool {
	return it == MSMQ
}

func (it Variant) IsIp() bool {
	return it == Ip
}

func (it Variant) IsIpV6() bool {
	return it == IpV6
}

func (it Variant) IsFtp() bool {
	return it == Ftp
}

func (it Variant) IsSmtp() bool {
	return it == Smtp
}

func (it Variant) IsImap() bool {
	return it == Imap
}

func (it Variant) IsPop3() bool {
	return it == Pop3
}
...
func (it Variant) IsSftp() bool {
	return it == Sftp
}

func (it Variant) IsTelnet() bool {
	return it == Telnet
}

func (it Variant) IsPam() bool {
	return it == Pam
}

func (it Variant) IsSso() bool {
	return it == Sso
}

func (it Variant) IsCustom() bool {
	return it == Custom
}
...
func (it Variant) IsTransactionProtocol() bool {
	return transactionProtocols[it]
}

func (it Variant) IsMailingProtocol() bool {
	return mailProtocols[it]
}

func (it Variant) IsInternetProtocol() bool {
	return ipProtocols[it]
}

func (it Variant) IsFirewallIpTablesProtocol() bool {
	return iptablesProtocols[it]
}
...
func (it Variant) CapitalName() string {
