...
func (it Variant) IsLevelNum(level int) bool {
	return int(it) == level
}

func (it Variant) IsLevel(level byte) bool {
	return byte(it) == level
}

func (it Variant) IsLevel1() bool {
	return it == Level1
}

func (it Variant) IsLevel2() bool {
	return it == Level2
}

func (it Variant) IsLevel3() bool {
	return it == Level3
}

func (it Variant) IsLevel4() bool {
	return it == Level4
}

func (it Variant) IsLevel5() bool {
	return it == Level5
}

func (it Variant) IsLevel6() bool {
	return it == Level6
}

func (it Variant) IsLevel7() bool {
	return it == Level7
}

func (it Variant) IsLevel8() bool {
	return it == Level8
}

func (it Variant) IsLevel9() bool {
	return it == Level9
}

func (it Variant) IsLevel10() bool {
	return it == Level10
}
...
func (it *Variant) AsLogLevelTyper() enuminf.LogLevelTyper {
	return it
}
