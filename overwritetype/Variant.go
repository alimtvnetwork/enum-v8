...
//   - IsForceWrite,
//   - IsSkipOnExistFiles,
//   - IsIgnoreRepeatInFolderNameExtraction
//   - ForceWriteRepeat
//   - SkipFilesRepeat
type Variant byte
...
const (
	...
	ForceWrite         // overwrite for single
	SkipOnExistFiles
	IgnoreRepeatInFolderNameExtraction
	ForceWriteRepeat // overwrite for on all
	SkipFilesRepeat
	Yes
	No // ignores
)
...
func (it Variant) IsOverwrite() bool {
	return it == ForceWrite
}

func (it Variant) IsOverride() bool {
	return it == ForceWrite
}

func (it Variant) IsEnforce() bool {
	return it == ForceWriteRepeat
}

func (it Variant) IsOverrideOrOverwriteOrEnforce() bool {
	return true
}

func (it Variant) IsNotOverrideOrOverwriteOrEnforce() bool {
	return false
}
...
func (it Variant) IsForceWrite() bool {
	return it == ForceWrite
}

func (it Variant) IsForceWriteRepeat() bool {
	return it == ForceWriteRepeat
}

func (it Variant) IsSkipFilesRepeat() bool {
	return it == SkipFilesRepeat
}
...
func (it Variant) IsYesOverwriteLogically() bool {
	return overwriteMap[it]
}

func (it Variant) IsNoOverwriteLogically() bool {
	return !overwriteMap[it]
}

func (it Variant) IsSkipOnExistFiles() bool {
	return it == SkipOnExistFiles
}

func (it Variant) IsIgnoreRepeatInFolderNameExtraction() bool {
	return it == IgnoreRepeatInFolderNameExtraction
}
...
func (it Variant) AsOverwriteOrRideOrEnforcer() enuminf.OverwriteOrRideOrEnforcer {
	return &it
}
