...
func (it Variant) IsStartState() bool {
	return it == Initiate
}

func (it Variant) IsInitiate() bool {
	return it == Initiate
}

func (it Variant) IsRunning() bool {
	return it == Running
}

func (it Variant) IsSuccessWithWarning() bool {
	return it == SuccessWithWarning
}

func (it Variant) IsFailedMiddleWithError() bool {
	return it == FailedMiddleWithError
}

func (it Variant) IsCompleteWithError() bool {
	return it == CompleteWithError
}

func (it Variant) IsEndState() bool {
	return CompletionMap[it]
}

func (it Variant) IsCompletedSuccess() bool {
	return it == Success
}

func (it Variant) IsCompletedWithIssues() bool {
	return it == CompleteWithError
}
...
func (it Variant) AsCompletionStateTyper() enuminf.CompletionStateTyper {
	return &it
}
