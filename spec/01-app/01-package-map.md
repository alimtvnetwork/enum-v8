...
> ⚠️ **Scope:** the per-package mirror layout below is **upstream `core-v9`**. `enum-v6` uses one shared `tests/creationtests/` package — see [`13-testing-patterns.md` §6.1](./13-testing-patterns.md#61-enum-v6-specific-layout).
