...
| 06 | [Cross-Repo Sync](./06-cross-repo-sync.md) | Cross-repo maintainers | [`cross-repo/core-v8/`](../../cross-repo/core-v8/) *(directory intentionally retains `core-v8` name — see Core memory)* |
...
- Per [06 — Cross-Repo Sync](./06-cross-repo-sync.md), any spec change
  ...
  `cross-repo/core-v8/` copy where applicable. (The directory keeps its
