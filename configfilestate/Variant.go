...
func (it Variant) IsUnchanged() bool {
	return it == Unchanged
}

func (it Variant) IsAdded() bool {
	return it == Added
}

func (it Variant) IsDeleted() bool {
	return it == Deleted
}

func (it Variant) IsPermission() bool {
	return it == Permission
}

func (it Variant) IsUnknownOrPermission() bool {
	return it == Invalid || it == Permission
}
...
// it == Invalid ||
// it == Permission ||
// it == MismatchFileOrDir
func (it Variant) IsUnsafeCase() bool {
	return it == Invalid || it == Permission || it == MismatchFileOrDir
}

func (it Variant) IsModified() bool {
	return it == Modified
}

// HasChangeLogically
//
// Anything other than Unchanged or Invalid considered to be changed
func (it Variant) HasChangeLogically() bool {
	return it != Unchanged
}

func (it Variant) HasNoChangeLogically() bool {
	return it == Unchanged
}

func (it Variant) HasChangeInContentLogically() bool {
	return it == Added ||
		it == Modified ||
		it == Deleted ||
		it == SymbolicLinkDelete ||
		it == SymbolicLinkAdded
}

func (it Variant) HasChangeInAttributesLogically() bool {
	return it == ChmodChanged ||
		it == ChownChanged
}

func (it Variant) IsSymbolicLinkAdded() bool {
	return it == SymbolicLinkAdded
}

func (it Variant) IsChmodChownBothChanged() bool {
	return it == ChmodChownBothChanged
}

func (it Variant) IsSizeOrChmodOrChownOrLastModifiedDateChangedLogically() bool {
	return it.IsChmodOrChownOrLastModifiedDateChangedLogically() ||
		it == SizeOrChmodOrChownOrLastModifiedDateChanged ||
		it == SizeChanged
}

func (it Variant) IsChmodOrChownOrLastModifiedDateChangedLogically() bool {
	return it == ChmodOrChownOrLastModifiedDateChanged ||
		it == ChmodChanged ||
		it == ChownChanged ||
		it == LastModifiedDateChanged
}
