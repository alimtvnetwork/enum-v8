...
| 02 | [`cicd-issues/02-internal-package-rule.md`](./cicd-issues/02-internal-package-rule.md) | Go's `internal/` rule rejects consumers under `enum-v3/...` due to declared module path mismatch | 🚫 Blocked on Task W (root cause = #01) |
