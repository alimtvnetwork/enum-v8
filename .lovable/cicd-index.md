...
| # | File | Title | Status |
|---|---|---|---|
| 01 | [`cicd-issues/01-go-mod-rename-bridge.md`](./cicd-issues/01-go-mod-rename-bridge.md) | `core-v9` ⇄ `core-v8` `go.mod` rename bridge breaks Go 1.25 builds | 🚫 Blocked on Task W |
| 02 | [`cicd-issues/02-internal-package-rule.md`](./cicd-issues/02-internal-package-rule.md) | Go's `internal/` rule rejects consumers under `enum-v2/...` due to declared module path mismatch | 🚫 Blocked on Task W (root cause = #01) |
