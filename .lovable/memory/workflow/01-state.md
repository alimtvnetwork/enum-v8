...
> **Last updated:** 2026-05-06 (Cycle 34 — backlog hygiene sweep: closed **S-001** (Go-1.22 toolchain pin obsolete since Tasks W+AG removed the `replace` bridge), **S-003** (already resolved by the pre-existing line-3 scope disclaimer in `spec/06-testing-guidelines/01-folder-structure.md`), and **S-004** (added the same upstream-vs-enum-v4 scope callout above the Test-Folder-Structure code fence in `spec/00-llm-integration-guide.md`). Open-suggestions list now shrinks 5 → 2 (S-002 + S-103/S-104/S-105/S-106/S-109 — actually 6 remaining; S-002 is deferred to Task AC). PI-002 marked plan-complete.).
