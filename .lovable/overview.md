# Project Overview — enum-v4

## Identity

- **Module path:** `github.com/alimtvnetwork/enum-v4` (renamed from `enum-v1`)
...
- `cross-repo/core-v8/` — mirror of a separate upstream repo. **Never** rename `core-v8` → `core-v9` here. **Never** rewrite `enum-v1` → `enum-v4` here.
