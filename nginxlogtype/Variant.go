...
func (it Variant) IsNotice() bool {
	return it == Notice
}

func (it Variant) IsAlert() bool {
	return it == AlertError
}

func (it Variant) IsFileIssue() bool {
	return it == FileIssueError
}

func (it Variant) IsSyntaxIssue() bool {
	return it == SyntaxIssueError
}

func (it Variant) IsDuplicateDomain() bool {
	return it == DuplicateDomainWarningError
}

func (it Variant) IsDuplicateDefault() bool {
	return it == DuplicateDefaultError
}
