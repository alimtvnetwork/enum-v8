...
func (it Variant) IsDefinedAccepted() bool {
	return it.IsDefinedLogically() && it == Accept
}

func (it Variant) IsDefinedRejected() bool {
	return it.IsDefinedLogically() && it == Reject
}
...
// Name
//
// Accept, Reject ... returns from Ranges
