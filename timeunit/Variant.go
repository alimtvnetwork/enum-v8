...
func (it Variant) IsMillisecond() bool {
	return it == Millisecond
}

func (it Variant) IsMonth() bool {
	return it == Month
}

func (it Variant) IsYear() bool {
	return it == Year
}

func (it Variant) IsDay() bool {
	return it == Day
}

func (it Variant) IsHour() bool {
	return it == Hour
}

func (it Variant) IsMinute() bool {
	return it == Minute
}

func (it Variant) IsSecond() bool {
	return it == Second
}
