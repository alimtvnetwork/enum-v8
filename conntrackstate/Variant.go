...
//
//	These enums represent connection track states
type Variant byte
...
func (it Variant) IsNew() bool {
	return it == New
}

func (it Variant) IsEstablished() bool {
	return it == Established
}

func (it Variant) IsRelated() bool {
	return it == Related
}

func (it Variant) IsUntracked() bool {
	return it == Untracked
}

func (it Variant) IsSnat() bool {
	return it == Snat
}

func (it Variant) IsDnat() bool {
	return it == Dnat
}
