...
const (
	...
	RemoveSudoers
	CreateOrUpdate
	OnlyKeepUsersToGroup
	OnlyKeepUsersToSudoers
	RemoveAllUsers // group name
	AddUsersToGroupUsingFile
	OnlyKeepUsersToGroupUsingFile
	OnlyKeepUsersToSudoersUsingFile
	Profile
	Details
	ListJson
	List
