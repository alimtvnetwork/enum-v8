...
const (
	...
	AddRecordJson
	AddOrUpdateRecord
	AddOrUpdateRecordPrompt
	AddOrUpdateRecordJson
	AddARecord // https://t.ly/sjAC
	AddCnameRecord
	AddMxRecord
	AddDmarcRecord
	AddDomainKeyRecord
	...
	AddWwwRecord
	AddMailRecord
	AddAcmeChallengeRecord
	AddSoaRecord
	AddSoaRecordPrompt
	AddSoaRecordJson
	AddSameIpForHostname // https://t.ly/TXXJ
	UpdateRecord
	UpdateCnameRecord
	UpdateMxRecord
	UpdateDmarcRecord
	UpdateDomainKeyRecord
	UpdateSmtpRecord
	UpdateTxtRecord
	UpdateImapRecord
	UpdateWwwRecord
	UpdateMailRecord
	UpdateAcmeChallengeRecord
	UpdateSoaRecord
	AddOrUpdateCnameRecord
	AddOrUpdateMxRecord
	AddOrUpdateDmarcRecord
	AddOrUpdateDomainKeyRecord
	AddOrUpdateSmtpRecord
	AddOrUpdateTxtRecord
	AddOrUpdateImapRecord
	AddOrUpdateWwwRecord
	AddOrUpdateMailRecord
	AddOrUpdateAcmeChallengeRecord
	AddOrUpdateSoaRecord
	HasRecord
	RemoveRecord
	RemoveAcmeChallenge
	RemoveRecordOnExist
