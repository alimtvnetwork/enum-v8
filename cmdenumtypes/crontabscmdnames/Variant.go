...
const (
	...
	ScheduleBefore
	ScheduleAfter
	SchedulePersonalBefore
	SchedulePersonalAfter
	ScheduleEveryMinute
	ScheduleEverySecond
	ScheduleEveryHour
	ScheduleEveryday
	...
	RemoveAllSchedule
	UserSchedule
	UserScheduleEveryMinute
	UserScheduleEverySecond
	UserScheduleEveryHour
	UserScheduleEveryday
	UserScheduleWeekly
	UserScheduleMonthly
	UserScheduleYearly
	UserScheduleUpdate
	...
	UserScheduleBash
	UserScheduleTask
	UserRemoveAllSchedule
	EveryRebootSchedule
	RebootScheduleOnce
	EveryShutdownSchedule
	EveryStartupSchedule
	StartupScheduleOnce
	EveryHour
	EveryDay
	EveryMonth
