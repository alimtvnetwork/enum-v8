...
func (it Variant) IsV4() bool {
	return it == V4
}

func (it Variant) IsV6() bool {
	return it == V6
}

func (it Variant) IsVersion4() bool {
	return it == V4
}

func (it Variant) IsVersion6() bool {
	return it == V6

}

func (it Variant) IsIp4() bool {
	return it == V4
}

func (it Variant) IsIp6() bool {
	return it == V6
}
