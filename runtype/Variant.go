...
func (it Variant) IsNow() bool {
	return it == Now
}

func (it Variant) IsOnReboot() bool {
	return it == OnReboot
}

func (it Variant) IsOnShutdown() bool {
	return it == OnShutdown
}

func (it Variant) IsOnEveryReboot() bool {
	return it == OnEveryReboot
}

func (it Variant) IsOnEveryShutdown() bool {
	return it == OnEveryShutdown
}

func (it Variant) IsOnFailRetry() bool {
	return it == OnFailRetry
}

func (it Variant) IsEveryMinute() bool {
	return it == EveryMinute
}

func (it Variant) IsEveryHour() bool {
	return it == EveryHour
}

func (it Variant) IsEveryDay() bool {
	return it == EveryDay
}

func (it Variant) IsEveryMonth() bool {
	return it == EveryMonth
}

func (it Variant) IsEveryYear() bool {
	return it == EveryYear
}
