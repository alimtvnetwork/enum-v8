...
// Variant
//
// AllComplete, AfterRestart, AfterNetworkReset
type Variant byte
...
func (it Variant) IsAllComplete() bool {
	return it == AllComplete
}

func (it Variant) IsAfterRestart() bool {
	return it == AfterRestart
}

func (it Variant) IsAfterNetworkReset() bool {
	return it == AfterNetworkReset
}
