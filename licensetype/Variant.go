...
// Variant
//
//	Invalid, PublicDomain, ByCc
//	BySa, BySa, ByNc
//	ByNcSa
//
// Reference
//   - License Types : https://en.wikipedia.org/wiki/Creative_Commons_license
type Variant byte
...
func (it Variant) IsPublicDomain() bool {
	return it == PublicDomain
}

func (it Variant) IsByCc() bool {
	return it == ByCc
}

func (it Variant) IsBySa() bool {
	return it == BySa
}

func (it Variant) IsByNc() bool {
	return it == ByNc
}

func (it Variant) IsByNcSa() bool {
	return it == ByNcSa
}

func (it Variant) IsByNd() bool {
	return it == ByNd
}

func (it Variant) IsByNcNd() bool {
	return it == ByNcNd
}
