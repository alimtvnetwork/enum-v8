...
func (it Variant) IsFile() bool {
	return it == File
}

func (it Variant) HasPattern(pattern string) bool {
	panic(errcore.NotSupportedType.Error(pattern, it))
}
...
func (it Variant) HasNoLog() bool {
	return it == Silent || it == Invalid
}
...
func (it Variant) IsInfo() bool {
	return it == Info
}

func (it Variant) IsDebug() bool {
	return it == Debug
}
...
func (it Variant) IsErrorFatalLogical() bool {
	return ErrorMap[it] && it != Panic
}

func (it Variant) IsErrorFatalPanicLogical() bool {
	return ErrorMap[it]
}

func (it Variant) IsLogNameEqual(name string) bool {
	return it.Name() == name
}

func (it Variant) IsLogValueEqual(logVal byte) bool {
	return it.ValueByte() == logVal
}
...
// here; return the last real member (Pattern) directly.
...
func (it Variant) AsLoggerTyper() enuminf.LoggerTyper {
	return &it
}
