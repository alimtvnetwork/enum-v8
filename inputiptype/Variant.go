...
func (it Variant) IsIpWithSubnet() bool {
	return it == IpWithSubnet
}

func (it Variant) IsSubnetMask() bool {
	return it == SubnetMask
}

func (it Variant) IsGateway() bool {
	return it == Gateway
}

func (it Variant) IsIPWithPort() bool {
	return it == IpWithPort
}
